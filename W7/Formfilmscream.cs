...
namespace W7
{
    public partial class Formfilmscream : Form
    {
        ...
        int b = 0;
        int bantu = 0;
        public Formfilmscream()
        {
            InitializeComponent();
        }

        private void Formfilmscream_Load(object sender, EventArgs e)
        {
        ...
        private void Kursi3_Click(object sender, EventArgs e)
        {
            ...
            Label oil = new Label();
            oil.Location = new Point(305, 240);
            oil.Size = new Size(30, 300);
            oil.Text = "oee ";
            panell.Controls.Add(oil);
